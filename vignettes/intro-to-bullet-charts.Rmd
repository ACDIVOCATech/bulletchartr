...
{bulletchartr} contains 4 different chart functions divided into two categories, the regular bullet chart (`bullet_chart()`) and the time-constraint versions (`bullet_chart_wide()`, `bullet_chart_symbol()`, and `bullet_chart_vline()`).

...
The color inside the bar is __green__ if we are near or past the `TODAY` line, __orange__ when weâ€™re close and __red__ when we're very behind schedule/target.
